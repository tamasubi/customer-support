...
class ComplaintsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create complaint" do
    assert_difference('Complaint.count') do
      post complaints_url, params: { complaint: { description: @complaint.description, status: @complaint.status, title: @complaint.title, top_priority: @complaint.top_priority } }
    end
  ...
  test "should update complaint" do
    patch complaint_url(@complaint), params: { complaint: { description: @complaint.description, status: @complaint.status, title: @complaint.title, top_priority: @complaint.top_priority } }
